#!/bin/sh
# Self-contained replication of EXP-B · R02 Update Base Image TAG · Performance
...
A=$(size "$TAG:after")
echo ""
echo "EXP-B · R02 Update Base Image TAG · Performance"
echo "  before: $B"
echo "  after:  $A"
echo "  delta:  $((A - B))"
echo "  measured_utc: $(date -u +%Y-%m-%dT%H:%M:%SZ)"
echo "  base_digest: n/a — EXP-B deliberately uses a mutable tag"
echo ""
