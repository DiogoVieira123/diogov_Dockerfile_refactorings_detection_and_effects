#!/usr/bin/env python3
"""
verify_poc.py — standalone verification for R02 — Update Base Image TAG.
...
BEFORE_DF = HERE / "before/Dockerfile"
...
REPORTED = {'delta_instr': 0, 'delta_size': -11845577, 'delta_cves': -26, 'delta_warnings': -1}
TAG = "verify-poc-2"
...
def main():
    ...
    print()
    print("=" * 86)
    print(f"  R02 — Update Base Image TAG")
