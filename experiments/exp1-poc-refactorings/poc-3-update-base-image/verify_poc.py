#!/usr/bin/env python3
"""
verify_poc.py — standalone verification for R10 — Update Base Image.
...
REPORTED = {'delta_instr': 0, 'delta_size': -26318550, 'delta_cves': -15, 'delta_warnings': 0}
TAG = "verify-poc-3"
