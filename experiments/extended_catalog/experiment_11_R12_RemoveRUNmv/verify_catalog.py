#!/usr/bin/env python3
"""
verify_catalog.py — standalone verification for R12 — Remove RUN.
...
REPORTED = {'delta_instr': -2, 'delta_size': -1331, 'delta_cves': 0, 'delta_warnings': 0}
TAG = "verify-exp-r12"
