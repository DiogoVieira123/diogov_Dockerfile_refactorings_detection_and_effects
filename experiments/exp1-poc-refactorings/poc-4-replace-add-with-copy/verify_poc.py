#!/usr/bin/env python3
"""
verify_poc.py — standalone verification for R08 — Replace ADD with COPY.
...
REPORTED = {'delta_instr': 0, 'delta_size': 3, 'delta_cves': 0, 'delta_warnings': -1}
TAG = "verify-poc-4"
...
def main():
    ...
    print()
    print("=" * 86)
    print(f"  R08 — Replace ADD with COPY")
