#!/usr/bin/env python3
"""
verify_catalog.py — standalone verification for R09 — Extract RUN Instructions.
...
REPORTED = {'delta_instr': 1, 'delta_size': 417, 'delta_cves': 0, 'delta_warnings': 0}
TAG = "verify-exp-r09"
...
def main():
    ...
    print()
    print("=" * 86)
    print(f"  R09 — Extract RUN Instructions")
