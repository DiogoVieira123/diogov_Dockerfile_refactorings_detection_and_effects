...
# The maintainability benefit (a simpler single-stage Dockerfile) is argued from the nature of the operation, not claimed as a measured improvement.
#
# Usage:  bash measure.sh        (or: sudo bash measure.sh, if docker needs root)
# Output: printed to stdout AND saved to output.txt

set -u
BEFORE_TAG="r06-before:test"
AFTER_TAG="r06-after:test"
...
log "=================================================="
log " R06 - Inline Stage"
log " Experiment 1 - Extended Catalog"
